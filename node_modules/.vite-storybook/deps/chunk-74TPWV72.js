...
var require_iterators_core = __commonJS({
  "node_modules/core-js/internals/iterators-core.js"(exports, module) {
    ...
    var NEW_ITERATOR_PROTOTYPE = !isObject2(IteratorPrototype) || fails3(function() {
      var test = {};
  ...
  "node_modules/core-js/internals/collection.js"(exports, module) {
    ...
    module.exports = function(CONSTRUCTOR_NAME, wrapper, common) {
      ...
      var REPLACE2 = isForced(
        CONSTRUCTOR_NAME,
        !isCallable2(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails3(function() {
...
var require_regexp_sticky_helpers = __commonJS({
  "node_modules/core-js/internals/regexp-sticky-helpers.js"(exports, module) {
    ...
    var UNSUPPORTED_Y = fails3(function() {
      var re = $RegExp("a", "y");
      re.lastIndex = 2;
      return re.exec("abcd") != null;
    });
    var MISSED_STICKY = UNSUPPORTED_Y || fails3(function() {
      return !$RegExp("a", "y").sticky;
    });
    var BROKEN_CARET = UNSUPPORTED_Y || fails3(function() {
      var re = $RegExp("^r", "gy");
      re.lastIndex = 2;
...
//# sourceMappingURL=chunk-74TPWV72.js.map
